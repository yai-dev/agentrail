...
export const echoTool = defineTool({
  name: "echo",
  description:
    "Returns the provided message back to the caller. Useful for testing hook observability.",
...
export const defaultProfile = defineProfile({
  ...
  agent: {
    ...
    prompt:
      "You are a helpful assistant. You have access to an echo tool — use it when the user asks you to echo something.",
    tools: [echoTool],
  },
});
