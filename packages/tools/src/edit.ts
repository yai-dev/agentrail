...
const parametersSchema = Type.Object({
    ...
    old_string: Type.String({
        description: "The text to replace. Must match the file content exactly, including all whitespace and indentation.",
    }),
    ...
    replace_all: Type.Optional(
        Type.Boolean({
            description: "If true, replaces all occurrences of old_string. Defaults to false (replaces only the first occurrence).",
            default: false,
        }),
    ),
});
